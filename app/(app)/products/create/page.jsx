...
export default function Page() {
    return (
        <>
            ...
            {/*                <div className="grid gap-1.5">*/}
            {/*                    <Label htmlFor="productFrom">Product From</Label>*/}
            {/*                    <Input type="text" id="productFrom" placeholder="Product From" name="productFrom"/>*/}
            {/*                </div>*/}
            {/*            </div>*/}

            {/*            <div className="grid gap-4 sm:grid-cols-3">*/}
            {/*                <div className="grid gap-1.5">*/}
            {/*                    <Label htmlFor="priceBaht">Price in Baht</Label>*/}
            {/*                    <Input type="number" id="priceBaht" placeholder="Price in baht" name="priceBaht"/>*/}
            {/*                </div>*/}

            {/*                <div className="grid gap-1.5">*/}
            {/*                    <Label htmlFor="priceDong">Price in Dong</Label>*/}
            {/*                    <Input type="number" id="priceDong" placeholder="Price in Dong" name="priceDong"/>*/}
            {/*                </div>*/}

            {/*                <div className="grid gap-1.5">*/}
            {/*                    <Label htmlFor="priceUsd">Price in USD</Label>*/}
            {/*                    <Input type="number" id="priceUsd" placeholder="Price in USD" name="priceUsd"/>*/}
            {/*                </div>*/}
            {/*            </div>*/}

            {/*            <div className="grid gap-4 sm:grid-cols-3">*/}
            {/*                <div className="grid gap-1.5">*/}
            {/*                    <Label htmlFor="productProfit">Profit</Label>*/}
            {/*                    <Input type="number" id="productProfit" placeholder="Profit" name="productProfit"/>*/}
            {/*                </div>*/}

            {/*                <div className="grid gap-1.5">*/}
            {/*                    <Label htmlFor="productSalePrice">Sale Price</Label>*/}
            {/*                    <Input type="number" id="productSalePrice" placeholder="Sale Price"*/}
